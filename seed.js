...
const main = async () => 
{
    ...
    try
    {
      ...
      const eventLinks = {
        ...
        let event2 = await event.createEvent("eltonvaz623", "Art Gallery", "Discover local talent and global creativity at our university art gallery", "2023-12-07", "20:00", "Stevens UCC", 10, eventLinks["Art Gallery"],"https://d1inegp6v2yuxm.cloudfront.net/royal-academy/image/upload/c_limit,cs_tinysrgb,dn_72,f_auto,fl_progressive.keep_iptc,w_1200/ioe5yo8wutsketramhnf.jpg");
        let event3 = await event.createEvent("SriBL", "Haunted House", "Experience spine-tingling thrills and eerie chills at our haunted house", "2023-12-08", "19:00", "Hoboken Haunted House", 20, eventLinks["Haunted House"],"https://danielwcheely.files.wordpress.com/2016/03/haunted-house-color.jpg?w=676");
        let event4 = await event.createEvent("TBayryyev", "Coding Workshop", "Join us for an interactive coding workshop!", "2023-12-08", "14:30", "Tech Hub", 15, eventLinks["Coding Workshop"],"https://cms-assets.themuse.com/media/lead/01212022-1047259374-coding-classes_scanrail.jpg");
        let event5 = await event.createEvent("eltonvaz623", "Book Club Meeting", "Discussing the latest bestseller - everyone's welcome!", "2023-12-09", "18:00", "Library", 10, eventLinks["Book Club Meeting"],"https://image.cnbcfm.com/api/v1/image/104702698-GettyImages-583816330-book-club.jpg?v=1532563764");
        let event6 = await event.createEvent("SriBL", "Fitness Bootcamp", "Get fit together in this high-energy bootcamp session!", "2023-12-11", "07:00", "City Park", 25, eventLinks["Fitness Bootcamp"],"https://tunturi.org/Blogs/2021-08/bootcamp-full-body-workout.jpg");
        let event7 = await event.createEvent("TBayryyev", "Financial Planning Seminar", "Learn smart financial strategies for the future!", "2023-12-12", "16:00", "Financial Center", 30, eventLinks["Financial Planning Seminar"],"https://smartasset.com/wp-content/uploads/sites/2/2022/08/plan-1.jpg");
        let event8 = await event.createEvent("codyf02", "Networking Mixer", "Connect and network with professionals from various industries.", "2023-12-14", "18:30", "Business Club", 20, eventLinks["Networking Mixer"],"https://imageio.forbes.com/specials-images/dam/imageserve/1135040422/960x0.jpg?height=474&width=711&fit=bounds");
